...
const ContactDetails = () => {
  return (
    <div className="p-6  rounded-xl shadow-lg w-full max-w-2xl mx-auto">
      <h2 className="text-3xl font-bold mb-6 text-white text-center">Contact Me</h2>
      <ul className="space-y-4">
        <li className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">

...
import { faHome, faUser, faBriefcase, faEnvelope, faFile, faCode } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <> 
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vishal Labana</span>
            </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
              ...
              <ul className="font-medium flex flex-col p-4 md:p-0 justify-around 
              lg:gap-10  mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
